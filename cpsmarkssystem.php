...
<html>
            ...
            <div id="home" class="grid-container tabcontents homeTab">
                <div class="side-bar home-side-bar">
                    ...
                    <div class="bottom-sb-box">
                        <button class="bt-sb-link"onclick="logoutcpsSys()">
                            <span class="bt-sb-title">Log Out</span>
                        </button>
         ...
         <div id="uploadRoot" class="body_root" style="display:none;" >
            ...
            <div class="main_root">
                ...
                <div class="up_row up_row_one">
                    <form method="post" action="gradeone.php" class="upload_box subject_math">
                    ...
                    <form method="post" action="gradethree.php" class="upload_box subject_eng">
                ...
                <div class="up_row up_row_two">
                    ...
                    <form method="post" action="gradefour.php" class="upload_box subject_scie">
                ...
                <div class="up_row up_row_three">
                    <form method="post" action="gradefive.php" class="upload_box subject_comp">
                    ...
                    <form method="post" action="gradesix.php" class="upload_box subject_insha">
                ...
                <div class="up_row up_row_three">
                    <form method="post" action="gradeseven.php" class="upload_box subject_comp">
                    ...
                    <form method="post" action="gradeeight.php" class="upload_box subject_insha">
                ...
                <div class="up_row up_row_three">
                    <form method="post" action="gradenine.php" class="upload_box subject_comp">
                    ...
                    <form method="post" action="gradeten.php" class="upload_box subject_insha">
    ...
    <!--END UPLOAD BOX-->
            ...
            <div id="performance" class="grid-container tabcontents performanceTab">
                ...
                <!--registration box-->
                <div class="central p-central-box">
                        <!--Registry box 
        -- function:
    ...
    <div id="studentRegbox" class="stdmainbx hbox">
        ...
        <hr>
        <form method="post" action="studentsregister.php" class="studentRegIn stdmainin">
            ...
            <div class="studentDetails stdgdatabx">
                <aside class="stda stdaside">
                    ...
                    <div class="studentRegbx sflex">
                        ...
                        <input type="text" id="studentRegNo" name="regno" class="sflexinp" placeholder="Registration Number">
                    </div>
                    ...
                    <div class="entryMarksbx sflex">
                        <p class="entryMarks">Entry Marks:</p>
    ...
    <!--END enter marks-->
            ...
            <div id="graphics" class="grid-container tabcontents graphicsTab">
                ...
                <div class="central g-central-box">
                            <!--Data table-->
                            <?php
